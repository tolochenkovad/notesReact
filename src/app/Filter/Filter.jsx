...
const Filter = ({
                    activeTag, activeCategory, searchValue,
        ...
        <>
            {
                activeTag === '' && activeCategory === ''
                    ?
                    <FormControl component="form" className={classes.filter} onSubmit={onSubmitForm}>
                    ...
                    <Grid container={true} className={classes.filter}>
                        {
                            activeTag !== '' ?
                                <Grid item={true} className={classes.tag}>
                                    {activeTag}
                                    <i onClick={onClickTag} className={clsx(classes.iconDel, 'fas fa-times')}/>
                                </Grid>
                                : null
                        }
                        {
                            activeCategory !== '' ?
                                <Grid item={true} className={classes.text}>
                                    {activeCategory}
                                    <i onClick={onClickCategory} className={clsx(classes.iconDel, 'fas fa-times')}/>
                                </Grid>
                                : null
                        }
                    </Grid>
